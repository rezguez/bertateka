...
$(document).ready(function() {
 var table = $('#example').DataTable( {
     "columnDefs": [
		...
		{ "data": "SERIE", "targets": 4, "visible": false },
		{ "data": "AUTOR", "targets": 5, "visible": false },
		{ "data": "FILA", "targets": 6, "visible": false },
		{ "data": "COLUMNA", "targets": 7, "visible": false },
		{ "data": "IDIOMA", "targets": 8, "visible": false },
		{ "data": "FONDO", "targets": 9, "visible": false },
		{ "data": "TIPO", "targets": 10, "visible": false },
		{ "data": "FECHAALTA", "targets": 11, "visible": false, "searchable": false  }
